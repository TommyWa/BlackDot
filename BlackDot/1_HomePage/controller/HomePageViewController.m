...
- (UICollectionView *)collectionView{
    ...
    fly.itemSize = CGSizeMake(WIDTH/3, WIDTH/3);
       ...
       if (nil == _collectionView) {
        ...
        [_collectionView registerClass:[HomePageButtonCell class] forCellWithReuseIdentifier:@"biubiu"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HomePageButtonCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"biubiu" forIndexPath:indexPath];
